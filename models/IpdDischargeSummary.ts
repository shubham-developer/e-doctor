...
const IpdDischargeSummarySchema = new Schema<IIpdDischargeSummary>(
  {
    ...
    ipdId:                  { type: Schema.Types.ObjectId, ref: 'IpdAdmission', required: true, unique: true },
...
if (process.env.NODE_ENV !== 'production' && mongoose.models.IpdDischargeSummary) {
  delete (mongoose.models as Record<string, unknown>).IpdDischargeSummary
}
export default mongoose.model<IIpdDischargeSummary>('IpdDischargeSummary', IpdDischargeSummarySchema)
