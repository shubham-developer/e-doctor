...
const billColumns: ColumnDef<PharmacyBill>[] = [
  ...
  },
  {
    ...
    render: b => fmt(b.totalAmount),
  },
  {
    key: 'discountAmount', header: 'Discount ($)', align: 'right', skeletonWidth: 'w-20',
    csvValue: b => fmt(b.discountAmount),
    render: b => `${fmt(b.discountAmount)} (${b.totalAmount > 0 ? fmt(b.discountAmount / b.totalAmount * 100) : '0.00'}%)`,
  },
  {
    key: 'taxAmount', header: 'Tax ($)', align: 'right', skeletonWidth: 'w-16',
    csvValue: b => fmt(b.taxAmount),
    render: b => `${fmt(b.taxAmount)} (${b.totalAmount > 0 ? fmt(b.taxAmount / b.totalAmount * 100) : '0.00'}%)`,
  },
  {
  ...
  },
  {
    ...
    render: b => {
      ...
      return <span className={bal > 0 ? 'text-red-600 font-medium' : ''}>{fmt(Math.max(0, bal))}</span>
    },
  },
]
