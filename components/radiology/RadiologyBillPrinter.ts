...
<head>
  <meta charset="utf-8" />
  <title>Radiology Bill – ${e(data.clinicName)}</title>
  <style>
...
<body>
  ...
  <div class="header">
    <div class="logo-area">
      ${data.logoUrl
        ...
        : `<div style="display:inline-block;background:#1a1a1a;color:#fff;font-size:10px;font-weight:bold;padding:2px 7px;letter-spacing:1px;margin-bottom:4px">&#9651; ${e(data.clinicName.split(' ')[0].toUpperCase())}</div>`
      }
  ...
  <div class="bill-bar">Radiology Bill</div>
