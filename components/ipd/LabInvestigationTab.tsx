  ...
  async function handleAdd() {
    ...
    try {
      const d = await apiClient.post(`/api/dashboard/ipd/${ipdId}/lab-tests`, {
        ...
        categoryName: selected?.chargeName,
      ...
      if (d.success) {
        ...
        toast.error((d as { error?: string }).error ?? "Failed to add test");
    } finally {
      setSaving(false);
    }
  }
    ...
    <div className="p-4 space-y-4">
      ...
      {showForm && (
        <div className="border border-primary-200 bg-primary-50/40 rounded-lg p-4 space-y-3">
          <p className="text-xs font-semibold text-primary-700">Add Lab Test</p>
          ...
          <div className="flex justify-end gap-2 pt-1">
            ...
            <button
              onClick={handleAdd}
              disabled={saving || !searchInput.trim()}
