...
export function MasterDataSection({
  ...
  async function toggleActive(item: MasterItem) {
    const res = await apiClient.patch(`${apiBase}/${item._id}`, { isActive: !item.isActive })
  ...
  async function remove(id: string) {
    ...
    if (res.success) { toast.success(`${title} deleted`); load(); onChanged?.() }
    else toast.error(res.error)
  }
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>This {title.toLowerCase()} will be removed.</AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
